 ...
 * @id         $Id: locallib.php 4752 2018-05-31 15:06:04Z pholden $
 */
 ...
 */
function local_mediaserver_stream_add($source, $reference, $title, $description, $category, $userid = 0, $comments = 0) {
    global $DB, $USER;
 ...
 * @return \local_mediaserver\media_schedule
 *
...
/**
 * Return an instance of configured/current media schedule plugin
 *
 * @return \local_mediaserver\media_schedule
 */
function local_mediaserver_schedule_current() {
    $schedulesource = get_config('local_mediaserver', 'schedulesource');

    return local_mediaserver_schedule_instance($schedulesource);
}
...
function local_mediaserver_schedule_download(stdClass $channel, $start, $finish) {
    ...
    try {
        ...
        $schedule = local_mediaserver_schedule_current();
