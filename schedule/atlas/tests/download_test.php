...
/**
 * Unit test for Atlas API schedule download method
 *
 * @group greenhead
 * @group local_mediaserver
 */
class mediaschedule_atlas_download_testcase extends schedule_download_testcase {
    ...
    public function test_download() {
        $class = '\\mediaschedule_atlas\\definition';
        $fixture = __DIR__ . '/fixtures/cbdj.json';
