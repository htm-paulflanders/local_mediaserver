 ...
 * @id         $Id: download_test.php 4708 2018-02-15 13:21:57Z pholden $
 */
...
class mediaschedule_direct_download_testcase extends schedule_download_testcase {
    ...
    public function test_schedule_dates($start, $finish, array $expected) {
        $result = phpunit_util::call_internal_method(new definition, 'schedule_dates', [$start, $finish], definition::class);
