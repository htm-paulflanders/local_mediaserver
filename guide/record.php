 ...
 * @id         $Id: record.php 4558 2017-03-02 13:50:39Z pholden $
 */
...
if (local_mediaserver_program_has_series($program)) {
    ...
    if ($existing = $DB->get_record_sql($sql, array('title' => $program->title, 'series' => $program->series, 'episode' => $program->episode))) {
        ...
        $strexists = get_string('errorrecordingexists', 'local_mediaserver');
        echo $OUTPUT->render((new notification($strexists, notification::NOTIFY_INFO))->set_show_closebutton(false));
