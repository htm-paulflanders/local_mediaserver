 ...
 * @id         $Id: search.php 4843 2018-10-26 15:33:30Z pholden $
 */
...
if ($search !== null) {
    ...
    if (! $search->timeenddisable) {
        $dateend = usergetdate($search->timeend);
        $searchquery .= ' dateto:' . mktime(23, 59, 59, $dateend['mon'], $dateend['mday'], $dateend['year']);
    }
