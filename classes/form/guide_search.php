 ...
 * @id         $Id: guide_search.php 3770 2015-08-19 11:56:54Z pholden $
 */
...
class guide_search extends \moodleform {
    ...
    public function definition() {
        ...
        // Advanced checkbox element used for genre select doesn't handle 'empty' array, so reset it.
        unset($search->genre);
        $search->genre = optional_param_array('genre', [], PARAM_NOTAGS);
